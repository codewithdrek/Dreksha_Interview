...
public class DIandSetters {
	...
	//Does that make sense? In your first example, you're asking Spring to give you an 
	
	//instance of BookingService, 
	//but you're never creating one, so Spring has nothing to give you. 
	
	//In your second example, you're creating a new instance of BookingService, 
	//telling Spring about it, and then, in the main() method, asking for it back.
